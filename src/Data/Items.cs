...
namespace TunicRandomizer {
    ...
    public class ItemLookup {
        ...
        public static Dictionary<string, ItemData> Items = new Dictionary<string, ItemData>() {
            // Consumables
            { "Firecracker", new ItemData("Firecracker", "filler", "Firecracker", ItemTypes.INVENTORY, 1) },
            { "Firecracker x2", new ItemData("Firecracker x2", "filler", "Firecracker", ItemTypes.INVENTORY, 2) },
            { "Firecracker x3", new ItemData("Firecracker x3", "filler", "Firecracker", ItemTypes.INVENTORY, 3) },
            { "Firecracker x4", new ItemData("Firecracker x4", "filler", "Firecracker", ItemTypes.INVENTORY, 4) },
            { "Firecracker x5", new ItemData("Firecracker x5", "filler", "Firecracker", ItemTypes.INVENTORY, 5) },
            { "Firecracker x6", new ItemData("Firecracker x6", "filler", "Firecracker", ItemTypes.INVENTORY, 6) },
            { "Fire Bomb", new ItemData("Fire Bomb", "filler", "Firebomb", ItemTypes.INVENTORY, 1) },
            { "Fire Bomb x2", new ItemData("Fire Bomb x2", "filler", "Firebomb", ItemTypes.INVENTORY, 2) },
            { "Fire Bomb x3", new ItemData("Fire Bomb x3", "filler", "Firebomb", ItemTypes.INVENTORY, 3) },
            { "Ice Bomb", new ItemData("Ice Bomb", "filler", "Ice Bomb", ItemTypes.INVENTORY, 1) },
            { "Ice Bomb x2", new ItemData("Ice Bomb x2", "filler", "Ice Bomb", ItemTypes.INVENTORY, 2) },
            { "Ice Bomb x3", new ItemData("Ice Bomb x3", "filler", "Ice Bomb", ItemTypes.INVENTORY, 3) },
            { "Ice Bomb x5", new ItemData("Ice Bomb x5", "filler", "Ice Bomb", ItemTypes.INVENTORY, 5) },
            { "Lure", new ItemData("Lure", "filler", "Bait", ItemTypes.INVENTORY, 1) },
            { "Lure x2", new ItemData("Lure x2", "filler", "Bait", ItemTypes.INVENTORY, 2) },
            { "Pepper", new ItemData("Pepper", "filler", "Pepper", ItemTypes.INVENTORY, 1) },
            { "Pepper x2", new ItemData("Pepper x2", "filler", "Pepper", ItemTypes.INVENTORY, 2) },
            { "Ivy", new ItemData("Ivy", "filler", "Ivy", ItemTypes.INVENTORY, 1) },
            { "Ivy x3", new ItemData("Ivy x3", "filler", "Ivy", ItemTypes.INVENTORY, 3) },
            { "Effigy", new ItemData("Effigy", "filler", "Piggybank L1", ItemTypes.INVENTORY, 1) },
            { "HP Berry", new ItemData("HP Berry", "filler", "Berry_HP", ItemTypes.INVENTORY, 1) },
            { "HP Berry x2", new ItemData("HP Berry x2", "filler", "Berry_HP", ItemTypes.INVENTORY, 2) },
            { "HP Berry x3", new ItemData("HP Berry x3", "filler", "Berry_HP", ItemTypes.INVENTORY, 3) },
            { "MP Berry", new ItemData("MP Berry", "filler", "Berry_MP", ItemTypes.INVENTORY, 1) },
            { "MP Berry x2", new ItemData("MP Berry x2", "filler", "Berry_MP", ItemTypes.INVENTORY, 2) },
            { "MP Berry x3", new ItemData("MP Berry x3", "filler", "Berry_MP", ItemTypes.INVENTORY, 3) },
            ...
            { "Torch", new ItemData("Torch", "useful", "Torch", ItemTypes.INVENTORY, 1) },
            ...
            // Fox Prince Items
            { "Soul Dice", new ItemData("Soul Dice", "useful", "Soul Dice", ItemTypes.INVENTORY, 1) },
            { "Dart", new ItemData("Dart", "useful", "Dart", ItemTypes.INVENTORY, 1) },
