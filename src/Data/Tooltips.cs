...
namespace TunicRandomizer {
    public class Tooltips {
        ...
        public static Dictionary<string, string> OptionTooltips = new Dictionary<string, string>() {
            ...
            { "Hide Collected Checks", "Makes checks that have been collected by another player (such as via !collect or slot co-op) appear as already opened/completed. Inventory and ending screen counts will also reflect this.\nCan be toggled on/off at any point and the game will update/revert accordingly." },
