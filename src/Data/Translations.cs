...
namespace TunicRandomizer {
    public class Translations {
        ...
        public static Dictionary<string, string> EnglishToTrunic = new Dictionary<string, string>() {
            ...
            {"Atoll Southeast Fuse", "ahtawl sow%Est fyooz"},
            {"Atoll Southwest Fuse", "ahtawl sow%wehst fyooz"},
            {"Library Lab Fuse", "lIbrArE lahb fyooz"},
            {"Fortress Exterior Fuse 1", "fortruhs ehkstErEur fyooz 1"},
            {"Fortress Exterior Fuse 2", "fortruhs ehkstErEur fyooz 2"},
            {"Fortress Courtyard Upper Fuse", "fortruhs kortyRd uhpur fyooz"},
            {"Fortress Courtyard Fuse", "fortruhs kortyRd fyooz"},
            {"Beneath the Vault Fuse", "bEnE% #uh fortruhs fyooz"},
            {"Fortress Candles Fuse", "fortruhs kahnduhlz fyooz"},
            {"Fortress Door Left Fuse", "fortruhs lehft dor fyooz"},
            {"Fortress Door Right Fuse", "fortruhs rIt door fyooz"},
            {"Quarry Fuse 1", "kworE fyooz 1"},
