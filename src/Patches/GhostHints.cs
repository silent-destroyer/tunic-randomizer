    ...
    public class GhostHints {
        ...
        public static Dictionary<string, List<HintGhost>> GhostLocations = new Dictionary<string, List<HintGhost>>() {
            ...
            { "Inside Temple", new List<HintGhost>() {
                ...
                new HintGhost("Hint Ghost Inside Temple 2", "Temple", new Vector3(21.0f, 0.076f, 42.5f), new Quaternion(0f, 0.5736f, 0f, -0.8192f), NPC.NPCAnimState.WOE, $"mmmmm, #uh bloo tIuhlz tAst lIk bloo razbehrEz."), }
            },
