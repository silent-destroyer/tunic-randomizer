        ...
        {
            {
                ...
                {
                    new TunicPortal("Sword Cave", "", "Stick House Entrance", "Overworld"),
                    new TunicPortal("Windmill", "", "Windmill Entrance", "Overworld"),
                    new TunicPortal("Sewer", "entrance", "Well Ladder Entrance", "Overworld"),
                    new TunicPortal("Sewer", "west_aqueduct", "Entrance to Well from Well Rail", "Overworld Well to Furnace Rail", ignoreScene: true, givesAccess: new List<string> { "Overworld Redux, Furnace_gyro_upper_north" }, requiredItems: new Dictionary<string, int> { { "Overworld Redux, Furnace_gyro_upper_north", 1 } }),
                    new TunicPortal("Overworld Interiors", "house", "Old House Entry Door", "Overworld", requiredItems: new Dictionary<string, int> { {"Key (House)", 1} }), // make this match actual item name
                    new TunicPortal("Overworld Interiors", "under_checkpoint", "Old House Waterfall Entrance", "Overworld"),
                    new TunicPortal("Furnace", "gyro_upper_north", "Entrance to Furnace from Well Rail", "Overworld Well to Furnace Rail", ignoreScene: true, givesAccess: new List<string> { "Overworld Redux, Sewer_west_aqueduct" }, requiredItems: new Dictionary<string, int> { { "Overworld Redux, Sewer_west_aqueduct", 1 } }),
                    new TunicPortal("Furnace", "gyro_upper_east", "Entrance to Furnace from Windmill", "Overworld"),
                    new TunicPortal("Furnace", "gyro_west", "Entrance to Furnace from West Garden", "Overworld", ignoreScene: true, givesAccess: new List<string> {"Overworld Redux, Archipelagos Redux_lower"}, requiredItems: new Dictionary<string, int> { { "Overworld Redux, Archipelagos Redux_lower", 1 } }),
                    new TunicPortal("Furnace", "gyro_lower", "Entrance to Furnace from Beach", "Overworld"),
                    new TunicPortal("Overworld Cave", "", "Rotating Lights Entrance", "Overworld"),
                    new TunicPortal("Swamp Redux 2", "wall", "Swamp Upper Entrance", "Overworld", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1} }),
                    new TunicPortal("Swamp Redux 2", "conduit", "Swamp Lower Entrance", "Overworld"),
                    new TunicPortal("Ruins Passage", "east", "Ruined Hall Entrance Not-Door", "Overworld"),
                    new TunicPortal("Ruins Passage", "west", "Ruined Hall Entrance Door", "Overworld", requiredItems: new Dictionary<string, int> { { "Key", 2 } }), // and access to any overworld portal, but we start in overworld so no need to put it here
                    new TunicPortal("Atoll Redux", "upper", "Atoll Upper Entrance", "Overworld"),
                    new TunicPortal("Atoll Redux", "lower", "Atoll Lower Entrance", "Overworld"),
                    new TunicPortal("ShopSpecial", "", "Special Shop Entrance", "Overworld", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1} }),
                    new TunicPortal("Maze Room", "", "Maze Cave Entrance", "Overworld"),
                    new TunicPortal("Archipelagos Redux", "upper", "West Garden Entrance by Belltower", "Overworld", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1 } }),
                    new TunicPortal("Archipelagos Redux", "lower", "West Garden Entrance by Dark Tomb", "Overworld", ignoreScene: true, givesAccess: new List<string> {"Overworld Redux, Furnace_gyro_west"}, requiredItems: new Dictionary<string, int> {{"Overworld Redux, Furnace_gyro_west", 1}}),
                    new TunicPortal("Archipelagos Redux", "lowest", "West Garden Laurel Entrance", "Overworld", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1 } }),
                    new TunicPortal("Temple", "main", "Temple Door Entrance", "Overworld", requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Forest Belltower, Forest Boss Room_", 1 }, { "Overworld Redux, Archipelagos Redux_upper", 1 }, { "Stick", 1 } }, new Dictionary<string, int> { { "Forest Belltower, Forest Boss Room_", 1 }, { "Overworld Redux, Archipelagos Redux_upper", 1 }, { "Techbow", 1 } }, new Dictionary<string, int> { { "Forest Belltower, Forest Boss Room_", 1 }, { "Hyperdash", 1 }, { "Stick", 1 } }, new Dictionary<string, int> { { "Forest Belltower, Forest Boss Room_", 1 }, { "Hyperdash", 1 }, { "Techbow", 1 } } }),
                    new TunicPortal("Temple", "rafters", "Temple Rafters Entrance", "Overworld"),
                    new TunicPortal("Ruined Shop", "", "Ruined Shop Entrance", "Overworld"),
                    new TunicPortal("PatrolCave", "", "Patrol Cave Entrance", "Overworld"),
                    new TunicPortal("Town Basement", "beach", "Hourglass Cave Entrance", "Overworld"),
                    new TunicPortal("Changing Room", "", "Changing Room Entrance", "Overworld"),
                    new TunicPortal("CubeRoom", "", "Cube Room Entrance", "Overworld"),
                    new TunicPortal("Mountain", "", "Stairs from Overworld to Mountain", "Overworld"),
                    new TunicPortal("Fortress Courtyard", "", "Overworld to Fortress", "Overworld"),
                    new TunicPortal("Town_FiligreeRoom", "", "HC Room Entrance next to Changing Room", "Overworld", entryItems: new Dictionary<string, int> { { "21", 1 } }), // this is entry items because when you exit from this portal, you end up in front of the door
                    new TunicPortal("EastFiligreeCache", "", "Glass Cannon HC Room Entrance", "Overworld", requiredItems: new Dictionary<string, int> { { "21", 1 } }), // this is required items because when you exit from this portal, you end up behind the door
                    new TunicPortal("Darkwoods Tunnel", "", "Overworld to Quarry Connector", "Overworld"),
                    new TunicPortal("Crypt Redux", "", "Dark Tomb Main Entrance", "Overworld"),
                    new TunicPortal("Forest Belltower", "", "Overworld to Forest Belltower", "Overworld"),
                    new TunicPortal("Transit", "teleporter_town", "Town Portal", "Overworld", prayerPortal: true),
                    new TunicPortal("Transit", "teleporter_starting island", "Spawn Portal", "Overworld", prayerPortal: true),
                    new TunicPortal("Waterfall", "", "Entrance to Fairy Cave", "Overworld"),
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Fairy Cave Exit", "Waterfall", deadEnd: true),
                }
            },
            {
                "Windmill",
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Windmill Exit", "Windmill"),
                    new TunicPortal("Shop", "", "Windmill Shop", "Windmill"),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Changing Room Exit", "Changing Room", deadEnd: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Fountain HC Room Exit", "Town_FiligreeRoom", deadEnd: true),
                }
            },
            {
                "CubeRoom",
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Cube Room Exit", "CubeRoom", deadEnd: true),
                }
            },
            {
                "PatrolCave",
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Guard Patrol Cave Exit", "PatrolCave", deadEnd: true),
                }
            },
            {
                "Ruined Shop",
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Ruined Shop Exit", "Ruined Shop", deadEnd: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "gyro_upper_north", "Furnace to Well Rail", "Furnace", requiredItems: new Dictionary<string, int> { {"Hyperdash", 1} }),
                    new TunicPortal("Crypt Redux", "", "Furnace to Dark Tomb", "Furnace", requiredItems: new Dictionary<string, int> { {"Hyperdash", 1} }, givesAccess: new List<string> {"Furnace, Overworld Redux_gyro_west"}),
                    new TunicPortal("Overworld Redux", "gyro_west", "Furnace to West Garden", "Furnace", requiredItems : new Dictionary<string, int> { {"Hyperdash", 1} }, givesAccess : new List<string> {"Furnace, Crypt Redux_"}),
                    new TunicPortal("Overworld Redux", "gyro_lower", "Furnace to Beach", "Furnace"),
                    new TunicPortal("Overworld Redux", "gyro_upper_east", "Furnace to Windmill", "Furnace"),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Stick House Exit", "Sword Cave", deadEnd: true),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Glass Cannon HC Room Exit", "EastFiligreeCache", deadEnd: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Rotating Lights Exit", "Overworld Cave", deadEnd: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Maze Cave Exit", "Maze Room", deadEnd: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "beach", "Hourglass Cave Exit", "Town Basement", deadEnd: true), // yes, it has a tag even though it doesn't need one
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "", "Special Shop Exit", "ShopSpecial", deadEnd: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "rafters", "Temple Rafters Exit", "Temple"),
                    new TunicPortal("Overworld Redux", "main", "Temple Door Exit", "Temple"),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "entrance", "Well Ladder Exit", "Sewer"),
                    new TunicPortal("Sewer_Boss", "", "Well to Well Boss", "Sewer"),
                    new TunicPortal("Overworld Redux", "west_aqueduct", "Well Rail Exit", "Sewer"),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "lower", "West Garden towards Dark Tomb", "West Garden"),
                    new TunicPortal("archipelagos_house", "", "Magic Dagger House Entrance", "West Garden"),
                    new TunicPortal("Overworld Redux", "upper", "West Garden after Boss", "West Garden", ignoreScene: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Sword", 1 }, { "Archipelagos Redux, Overworld Redux_lower", 1 } }, new Dictionary<string, int> { { "Hyperdash", 1 }, {"Archipelagos Redux", 1 } } }),
                    new TunicPortal("Shop", "", "West Garden Shop", "West Garden"), // there's two of these, one is unused and disabled
                    new TunicPortal("Overworld Redux", "lowest", "West Garden Laurel Exit", "West Garden", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1 } }),
                    new TunicPortal("RelicVoid", "teleporter_relic plinth", "West Garden Hero's Grave", "West Garden", prayerPortal: true), // Hero grave
                    new TunicPortal("Transit", "teleporter_archipelagos_teleporter", "West Garden Portal", "West Garden Portal", prayerPortal: true, deadEnd: true), // Portal to the thing behind dagger house
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Archipelagos Redux", "", "Magic Dagger House Exit", "Magic Dagger House", deadEnd: true),
                }
            },
            {
                "Atoll Redux",
                new List<TunicPortal>
                {
                    new TunicPortal("Frog Stairs", "eye", "Frog Eye Entrance", "Atoll"),
                    new TunicPortal("Library Exterior", "", "Atoll to Library", "Atoll", prayerPortal: true),
                    new TunicPortal("Overworld Redux", "upper", "Upper Atoll Exit", "Atoll"),
                    new TunicPortal("Overworld Redux", "lower", "Lower Atoll Exit", "Atoll", requiredItems: new Dictionary<string, int> {{"Hyperdash", 1}}),
                    new TunicPortal("Frog Stairs", "mouth", "Frog Mouth Entrance", "Atoll", requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Wand", 1 } }, new Dictionary<string, int> { { "Hyperdash", 1 } } }),
                    new TunicPortal("Shop", "", "Atoll Shop", "Atoll"),
                    new TunicPortal("Transit", "teleporter_atoll", "Atoll Portal", "Atoll", prayerPortal: true),
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Atoll Redux", "mouth", "Frog Mouth Exit", "Frog Stairs"),
                    new TunicPortal("frog cave main", "Exit", "Upper Frog to Lower Frog Exit", "Frog Stairs"),
                    new TunicPortal("Atoll Redux", "eye", "Frog Eye Exit", "Frog Stairs"),
                    new TunicPortal("frog cave main", "Entrance", "Upper Frog to Lower Frog Entrance", "Frog Stairs"),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Frog Stairs", "Exit", "Lower Frog Orb Exit", "Frog's Domain Back", ignoreScene: true, requiredItems: new Dictionary<string, int> { { "Wand", 1 }, { "frog cave main, Frog Stairs_Entrance", 1 } }),
                    new TunicPortal("Frog Stairs", "Entrance", "Lower Frog Ladder Exit", "Frog's Domain Front", ignoreScene: true, oneWay: true),
                }
            },
            {
                "Library Exterior",
                new List<TunicPortal>
                {
                    new TunicPortal("Library Hall", "", "Library Entry Ladder", "Library Exterior", requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Hyperdash", 1 } }, new Dictionary<string, int> { { "Wand", 1} } }),
                    new TunicPortal("Atoll Redux", "", "Library to Atoll", "Library Exterior", requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Hyperdash", 1 }, { "12", 1 } }, new Dictionary<string, int> { { "Wand", 1}, { "12", 1 } } }),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Library Rotunda", "", "Lower Library to Rotunda", "Library Hall"),
                    new TunicPortal("Library Exterior", "", "Library Bookshelf Exit", "Library Hall"),
                    new TunicPortal("RelicVoid", "teleporter_relic plinth", "Library Hero's Grave", "Library Hall", prayerPortal: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Library Hall", "", "Library Rotunda Lower Exit", "Library Rotunda"),
                    new TunicPortal("Library Lab", "", "Library Rotunda Upper Exit", "Library Rotunda"),
                }
            },
            {
                "Library Lab",
                new List<TunicPortal>
                {
                    new TunicPortal("Library Arena", "", "Upper Library to Librarian", "Library Lab", ignoreScene: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Hyperdash", 1 }, { "Library Lab", 1 } }, new Dictionary<string, int> { { "Wand", 1}, {"Library Lab", 1 } } }),
                    new TunicPortal("Library Rotunda", "", "Upper Library to Rotunda", "Library Lab", ignoreScene: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Hyperdash", 1 }, { "Library Lab", 1 } }, new Dictionary<string, int> { { "Wand", 1}, {"Library Lab, Library Rotunda_", 1 } } }),
                    new TunicPortal("Transit", "teleporter_library teleporter", "Library Portal", "Library Lab", ignoreScene: true, prayerPortal: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Hyperdash", 1 }, { "Library Lab, Library Rotunda_", 1 } }, new Dictionary<string, int> { { "Wand", 1}, {"Library Lab, Library Rotunda_", 1 } }, new Dictionary<string, int> { { "Library Lab", 1 } } }),
                }
            },
            {
                "Library Arena",
                new List<TunicPortal>
                {
                    new TunicPortal("Library Lab", "", "Library Librarian Arena Exit", "Library Arena", deadEnd: true),
                }
            },
            {
                "East Forest Redux",
                new List<TunicPortal>
                {
                    new TunicPortal("Sword Access", "lower", "Forest Grave Path Lower Entrance", "East Forest"),
                    new TunicPortal("East Forest Redux Laddercave", "upper", "Forest Fox Dance Outside Doorway", "East Forest", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1 } } ),
                    new TunicPortal("East Forest Redux Interior", "lower", "Forest Guard House 2 Lower Entrance", "East Forest"),
                    new TunicPortal("East Forest Redux Laddercave", "gate", "Forest Guard House 1 Gate Entrance", "East Forest"),
                    new TunicPortal("Sword Access", "upper", "Forest Grave Path Upper Entrance", "East Forest"),
                    new TunicPortal("East Forest Redux Interior", "upper", "Forest Guard House 2 Upper Entrance", "East Forest"),
                    new TunicPortal("East Forest Redux Laddercave", "lower", "Forest Guard House 1 Lower Entrance", "East Forest"),
                    new TunicPortal("Forest Belltower", "", "Forest to Belltower", "East Forest"),
                    new TunicPortal("Transit", "teleporter_forest teleporter", "Forest Portal", "East Forest", prayerPortal: true),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("East Forest Redux", "upper", "Upper Forest Grave Path Exit", "Sword Access", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1 } }),
                    new TunicPortal("East Forest Redux", "lower", "Lower Forest Grave Path Exit", "Sword Access"),
                    new TunicPortal("RelicVoid", "teleporter_relic plinth", "East Forest Hero's Grave", "Sword Access Back", ignoreScene: true, prayerPortal: true, requiredItems: new Dictionary<string, int> { {"Sword Access, East Forest Redux_lower", 1 } }), // Can't open the gate from behind
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Fortress Courtyard", "", "Forest Belltower to Fortress", "Forest Belltower Main"),
                    new TunicPortal("East Forest Redux", "", "Forest Belltower to Forest", "Forest Belltower Lower"),
                    new TunicPortal("Overworld Redux", "", "Forest Belltower to Overworld", "Forest Belltower Main"),
                    new TunicPortal("Forest Boss Room", "", "Forest Belltower to Guard Captain Room", "Forest Belltower Upper", ignoreScene: true, oneWay: true),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Fortress Reliquary", "Lower", "Lower Fortress Grave Path Entrance", "Fortress Courtyard"),
                    new TunicPortal("Fortress Reliquary", "Upper", "Upper Fortress Grave Path Entrance", "Fortress Courtyard Upper", ignoreScene: true, oneWay: true, givesAccess: new List<string> { "Fortress Courtyard, Fortress East_" }),
                    new TunicPortal("Fortress Main", "Big Door", "Fortress Courtyard to Fortress Interior", "Fortress Courtyard"),
                    new TunicPortal("Fortress East", "", "Fortress Courtyard to Fortress East", "Fortress Courtyard Upper", ignoreScene: true, oneWay: true, givesAccess: new List<string> { "Fortress Courtyard, Fortress Reliquary_Upper" }),
                    new TunicPortal("Fortress Basement", "", "Fortress Courtyard to Beneath the Earth", "Fortress Courtyard", ignoreScene: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "12", 1 }, { "Fortress Courtyard, Overworld Redux_", 1 } }, new Dictionary<string, int> { { "Hyperdash", 1 }, { "Fortress Courtyard", 1 } }, new Dictionary<string, int> { {"Fortress Courtyard, Shop_", 1 } } }),
                    new TunicPortal("Forest Belltower", "", "Fortress Courtyard to Forest Belltower", "Fortress Courtyard", requiredItems: new Dictionary<string, int>{ { "Hyperdash", 1 } }),
                    new TunicPortal("Overworld Redux", "", "Fortress Courtyard to Overworld", "Fortress Courtyard", ignoreScene: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { {"Hyperdash", 1}, { "Fortress Courtyard", 1 } }, new Dictionary<string, int> { {"Fortress Courtyard, Fortress East_", 1} }, new Dictionary<string, int> { { "Wand", 1 }, { "Fortress Courtyard, Forest Belltower_", 1 } } }), // remember, required items is just what you need to get to the center of a region -- prayer only gets you to the shop and beneath the earth
                    new TunicPortal("Shop", "", "Fortress Courtyard Shop", "Fortress Courtyard", ignoreScene: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "12", 1 }, { "Fortress Courtyard, Overworld Redux_", 1 } }, new Dictionary<string, int> { { "Hyperdash", 1 }, { "Fortress Courtyard", 1 } }, new Dictionary<string, int> { {"Fortress Courtyard, Fortress Basement_", 1 } } }),
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Fortress Main", "lower", "East Fortress to Interior Lower", "Fortress East Lower", ignoreScene: true, requiredItems: new Dictionary<string, int> { { "Fortress East, Fortress Main_upper", 1} }),
                    new TunicPortal("Fortress Courtyard", "", "East Fortress to Courtyard", "Fortress East"),
                    new TunicPortal("Fortress Main", "upper", "East Fortress to Interior Upper", "Fortress East"),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Fortress Courtyard", "Lower", "Lower Fortress Grave Path Exit", "Fortress Grave Path"),
                    new TunicPortal("Dusty", "", "Fortress Grave Path Dusty Entrance", "Fortress Grave Path", requiredItems: new Dictionary<string, int> { { "Hyperdash", 1 } }),
                    new TunicPortal("Fortress Courtyard", "Upper", "Upper Fortress Grave Path Exit", "Fortress Grave Path Upper", deadEnd: true),
                    new TunicPortal("RelicVoid", "teleporter_relic plinth", "Fortress Hero's Grave", "Fortress Grave Path", prayerPortal: true),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Darkwoods Tunnel", "", "Quarry to Overworld Exit", "Quarry"),
                    new TunicPortal("Shop", "", "Quarry Shop", "Quarry"),
                    new TunicPortal("Monastery", "front", "Quarry to Monastery Front", "Quarry"),
                    new TunicPortal("Monastery", "back", "Quarry to Monastery Back", "Monastery Rope", ignoreScene: true, oneWay: true),
                    new TunicPortal("Mountain", "", "Quarry to Mountain", "Quarry"),
                    new TunicPortal("ziggurat2020_0", "", "Quarry Zig Entrance", "Quarry", entryItems: new Dictionary<string, int> { { "Wand", 1 }, { "Darkwood Tunnel, Quarry Redux_", 1 }, { "12", 1 } }),
                    new TunicPortal("Transit", "teleporter_quarry teleporter", "Quarry Portal", "Quarry", prayerPortal: true, entryItems: new Dictionary<string, int> { { "Wand", 1 }, { "Darkwood Tunnel, Quarry Redux_", 1 }, { "12", 1 } }),
                }
            },
            {
                "Monastery",
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("ziggurat2020_1", "", "Zig 2 to Zig 1", "Zig 2 Top", ignoreScene: true, oneWay: true),
                    new TunicPortal("ziggurat2020_3", "", "Zig 2 to Zig 3", "Zig 2 Bottom", deadEnd: true, ignoreScene: true, requiredItems: new Dictionary<string, int>{{"ziggurat2020_2, ziggurat2020_1_", 1}}),
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("ziggurat2020_FTRoom", "", "Zig Portal Room Entrance", "Zig 3", ignoreScene: true, prayerPortal: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { {"Hyperdash", 1 }, { "ziggurat2020_3, ziggurat2020_2_", 1 } }, new Dictionary<string, int> { { "12", 1 }, { "ziggurat2020_3, ziggurat2020_2_", 1 } } }), // Prayer portal room
                    // new TunicPortal("ziggurat2020_1", "zig2_skip", "Zig Skip Exit"), // the elevator skip to lower zig
                    new TunicPortal("ziggurat2020_2", "", "Zig 3 to Zig 2", "Zig 3"),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Overworld Redux", "conduit", "Lower Swamp Exit", "Swamp Front"),
                    new TunicPortal("Cathedral Redux", "main", "Swamp to Cathedral Main Entrance", "Swamp Front", requiredItems: new Dictionary<string, int> { { "12", 1 }, { "Hyperdash", 1 }, { "Overworld Redux, Swamp Redux 2_wall", 1 } } ),
                    new TunicPortal("Cathedral Redux", "secret", "Swamp to Cathedral Treasure Room Entrance", "Swamp Front", requiredItems: new Dictionary<string, int> { { "21", 1 } }),
                    new TunicPortal("Cathedral Arena", "", "Swamp to Gauntlet", "Swamp Back", ignoreScene: true, requiredItemsOr: new List<Dictionary<string, int>> { new Dictionary<string, int> { { "Hyperdash", 1 }, {"Swamp Redux 2, Overworld Redux_wall", 1 } }, new Dictionary<string, int> { { "Swamp Redux 2, RelicVoid_teleporter_relic plinth", 1 } } }),
                    new TunicPortal("Shop", "", "Swamp Shop", "Swamp Front"),
                    new TunicPortal("Overworld Redux", "wall", "Upper Swamp Exit", "Swamp Back", ignoreScene: true, requiredItems: new Dictionary<string, int> { { "Hyperdash", 1 }, { "Swamp Redux 2, Cathedral Arena_", 1 } }),
                    new TunicPortal("RelicVoid", "teleporter_relic plinth", "Swamp Hero's Grave", "Swamp Back", ignoreScene: true, prayerPortal: true, requiredItems: new Dictionary<string, int> { { "Swamp Redux 2, Cathedral Arena_", 1 } }),
                }
            },
            {
                "Cathedral Redux",
                new List<TunicPortal>
                {
                    new TunicPortal("Swamp Redux 2", "main", "Cathedral Main Exit", "Cathedral"),
                    new TunicPortal("Cathedral Arena", "", "Cathedral Elevator", "Cathedral"),
                    new TunicPortal("Swamp Redux 2", "secret", "Cathedral Treasure Room Exit", "Cathedral Secret Legend", ignoreScene: true, deadEnd: true), // only one chest, just use item access rules for it
                }
            },
            {
                ...
                new List<TunicPortal>
                {
                    new TunicPortal("Swamp Redux 2", "", "Gauntlet to Swamp", "Gauntlet Bottom", ignoreScene: true, deadEnd: true, requiredItems: new Dictionary<string, int>{{"Cathedral Arena, Cathedral Redux_", 1}, {"Hyperdash", 1}}),
                    new TunicPortal("Cathedral Redux", "", "Gauntlet Elevator", "Gauntlet Top", ignoreScene: true, givesAccess: new List<string> {"Cathedral Arena, Shop_"}, requiredItems: new Dictionary<string, int>{{"Cathedral Arena, Shop_", 1}}),
                    new TunicPortal("Shop", "", "Gauntlet Shop", "Gauntlet Top", ignoreScene: true, givesAccess: new List<string> {"Cathedral Arena, Swamp Redux 2_"}, requiredItems: new Dictionary<string, int>{{"Cathedral Arena, Cathedral Redux_", 1}}), // we love gauntlet shop
                }
            },
            //{
