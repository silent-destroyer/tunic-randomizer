...
namespace TunicRandomizer {
    ...
    public class TunicRandomizer : BasePlugin {
        ...
        public override void Load() {
            ...
            Harmony.Patch(AccessTools.Method(typeof(InventoryDisplay), "equip"), new HarmonyMethod(AccessTools.Method(typeof(InventoryDisplayPatches), "InventoryDisplay_equip_PrefixPatch")));
